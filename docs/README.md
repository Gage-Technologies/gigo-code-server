...
GIGO's fork of [code-server](https://github.com/coder/code-server) to provide a more native experience in GIGO DevSpaces. If you're here and want a web based VSCode, it is better you use the original code-server from [Coder](https://github.com/coder). This fork is not of much use outside of GIGO.
